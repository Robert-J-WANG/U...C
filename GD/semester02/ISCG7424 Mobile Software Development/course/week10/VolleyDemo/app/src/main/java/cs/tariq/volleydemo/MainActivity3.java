                ...
                JsonObjectRequest jsObjRequest = new JsonObjectRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                StringBuilder myAnswers = new StringBuilder();
                                ...
                                try {
                                    ...
                                    for(int index = 0; index < data.length(); index++)
                                    {
                                        ...
                                        JSONArray iAnswers=item.getJSONArray("incorrect_answers");
                                        for(int j=0;j<iAnswers.length();j++){
                                            String incorrect_answer=iAnswers.getString(j);
                                            myAnswers.append("Answer"+(j+1)+":"+incorrect_answer+"\n");
                                        }
                                    }
                                ...
                                output.setText(myAnswers.toString());
